...
let personLarge = {
    name: "John",
    age: 25, //використовуємо деструктурізацію на об'єкті person
    address: {
        street: "123 Main St",
        city: "New York",
        country: "USA",
...
function copyObject(obj) {
    return { ...obj }; // Використовуємо синтаксис деструктурізації {...person} для створення новго об'єкта з тими ж властивостями
    // Повертаємо новий об'єкто
}
...
function destructureObject(obj) {
    const { brand, model } = obj; // Деструктуризація об'єкту laptop
    return `Brand: ${brand}, Model: ${model}`; // Повертаємо рядок з отриманими значеннями
}
...
function addProperty(array) {
    ...
    Object.defineProperty(Array.prototype, 'customProperty', {
        value: 'myProperty',
        enumerable: false, // Щоб забезпечити, що ця властивість не буде відображатись під час ітерацій
        configurable: true,
        writable: true
    });
